# Generated by Django 2.0.10 on 2019-04-13 17:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('prefer not to say', 'Prefer not to say'), ('male', 'Male'), ('female', 'Female')], default='(select sex)', max_length=64)),
