# Generated by Django 2.0.10 on 2019-02-24 16:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('prefer not to say', 'Prefer not to say'), ('male', 'Male'), ('female', 'Female')], default='(select sex)', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pi_set', models.OneToOneField(default=0, on_delete=django.db.models.deletion.CASCADE, to='surveys.PersonalInformation')),
            ],
            options={
                'verbose_name': 'Survey',
